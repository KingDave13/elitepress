...
import { Ejivol2iss6 } from "../constants";
...
const EjiVol2Iss6Pubs = () => {
    ...
    const totalItems = Ejivol2iss6.length;
    ...
    const currentItems = Ejivol2iss6.slice(startIndex, endIndex);
...
export default SectionWrapper(EjiVol2Iss6Pubs, '');