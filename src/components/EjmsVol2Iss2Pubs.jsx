...
import { Ejmsvol2iss2 } from "../constants";
...
const EjmsVol2Iss2Pubs = () => {
    ...
    const totalItems = Ejmsvol2iss2.length;
    ...
    const currentItems = Ejmsvol2iss2.slice(startIndex, endIndex);
...
export default SectionWrapper(EjmsVol2Iss2Pubs, '');