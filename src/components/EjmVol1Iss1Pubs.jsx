...
import { Ejmvol1iss1 } from "../constants";
...
const EjmVol1Iss1Pubs = () => {
    const isMobile = window.innerWidth <= 620;

    const itemsPerPage = 3;
    const [currentPage, setCurrentPage] = useState(1);
    const totalItems = Ejmvol1iss1.length;
    ...
    const currentItems = Ejmvol1iss1.slice(startIndex, endIndex);
...
export default SectionWrapper(EjmVol1Iss1Pubs, '');