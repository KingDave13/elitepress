...
import { Ejsrrvol2iss2 } from "../constants";
...
const EjsrrVol2Iss2Pubs = () => {
    ...
    const totalItems = Ejsrrvol2iss2.length;
    ...
    const currentItems = Ejsrrvol2iss2.slice(startIndex, endIndex);
...
export default SectionWrapper(EjsrrVol2Iss2Pubs, '');