...
import { Ejivol2iss7 } from "../constants";
...
const EjiVol2Iss7Pubs = () => {
    ...
    const totalItems = Ejivol2iss7.length;
    ...
    const currentItems = Ejivol2iss7.slice(startIndex, endIndex);
...
export default SectionWrapper(EjiVol2Iss7Pubs, '');