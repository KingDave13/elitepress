...
import { Ejmvol2iss1 } from "../constants";
...
const EjmVol2Iss1Pubs = () => {
    const isMobile = window.innerWidth <= 620;

    const itemsPerPage = 3;
    const [currentPage, setCurrentPage] = useState(1);
    const totalItems = Ejmvol2iss1.length;
    ...
    const currentItems = Ejmvol2iss1.slice(startIndex, endIndex);
...
export default SectionWrapper(EjmVol2Iss1Pubs, '');