...
import { Ejmvol2iss6 } from "../constants";
...
const EjmVol2Iss6Pubs = () => {
    ...
    const totalItems = Ejmvol2iss6.length;
    ...
    const currentItems = Ejmvol2iss6.slice(startIndex, endIndex);
...
export default SectionWrapper(EjmVol2Iss6Pubs, '');