...
import { Ejhvol2iss2 } from "../constants";
...
const EjhVol2Iss2Pubs = () => {
    ...
    const totalItems = Ejhvol2iss2.length;
    ...
    const currentItems = Ejhvol2iss2.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhVol2Iss2Pubs, '');