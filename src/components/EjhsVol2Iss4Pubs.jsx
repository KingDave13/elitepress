...
import { Ejhsvol2iss4 } from "../constants";
...
const EjhsVol2Iss4Pubs = () => {
    ...
    const totalItems = Ejhsvol2iss4.length;
    ...
    const currentItems = Ejhsvol2iss4.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhsVol2Iss4Pubs, '');