...
import { Ejhvol2iss4 } from "../constants";
...
const EjhVol2Iss4Pubs = () => {
    ...
    const totalItems = Ejhvol2iss4.length;
    ...
    const currentItems = Ejhvol2iss4.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhVol2Iss4Pubs, '');