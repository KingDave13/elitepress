...
import { Ejmvol2iss3 } from "../constants";
...
const EjmVol2Iss3Pubs = () => {
    ...
    const totalItems = Ejmvol2iss3.length;
    ...
    const currentItems = Ejmvol2iss3.slice(startIndex, endIndex);
...
export default SectionWrapper(EjmVol2Iss3Pubs, '');