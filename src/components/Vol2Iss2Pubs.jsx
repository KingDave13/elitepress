...
import { vol2iss2 } from "../constants";
...
const Vol2Iss2Pubs = () => {
    ...
    const totalItems = vol2iss2.length;
    ...
    const currentItems = vol2iss2.slice(startIndex, endIndex);
...
export default SectionWrapper(Vol2Iss2Pubs, '');