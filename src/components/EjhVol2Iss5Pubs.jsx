...
import { Ejhvol2iss5 } from "../constants";
...
const EjhVol2Iss5Pubs = () => {
    ...
    const totalItems = Ejhvol2iss5.length;
    ...
    const currentItems = Ejhvol2iss5.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhVol2Iss5Pubs, '');