        ...
        <div className='items-center w-full flex'>
            ...
            md:gap-10 ss:gap-8 gap-6 w-full'>
                <div className='w-full cursor-pointer shadow-md hover:shadow-lg 
                    ...
                    justify-center py-3'
                    onClick={() => {
                        navigate('/journals/EJHIV/Vol2/Vol2Iss1');
                    }}
                >
                ...
                <div className='w-full cursor-pointer shadow-md hover:shadow-lg 
                    ...
                    justify-center py-3'
                    onClick={() => {
                        navigate('/journals/EJHIV/Vol2/Vol2Iss2');
                    }}
                >
                    <p className="md:text-[20px] ss:text-[14px] font-medium">
                        Issue 2
                ...
                <div className='w-full cursor-pointer shadow-md hover:shadow-lg 
                    ...
                    justify-center py-3'
                    onClick={() => {
                        navigate('/journals/EJHIV/Vol2/Vol2Iss3');
                    }}
                >
                    <p className="md:text-[20px] ss:text-[14px] font-medium">
                        Issue 3
                ...
                <div className='w-full cursor-pointer shadow-md hover:shadow-lg 
                    ...
                    justify-center py-3'
                    onClick={() => {
                        navigate('/journals/EJHIV/Vol2/Vol2Iss4');
                    }}
                >
                    <p className="md:text-[20px] ss:text-[14px] font-medium">
                        Issue 4
                ...
                <div className='w-full cursor-pointer shadow-md hover:shadow-lg 
                    ...
                    justify-center py-3'
                    onClick={() => {
                        navigate('/journals/EJHIV/Vol2/Vol2Iss5');
                    }}
                >
                    <p className="md:text-[20px] ss:text-[14px] font-medium">
                        Issue 5
                ...
                <div className='w-full cursor-pointer shadow-md hover:shadow-lg 
                    ...
                    justify-center py-3'
                    onClick={() => {
                        navigate('/journals/EJHIV/Vol2/Vol2Iss6');
                    }}
                >
                    <p className="md:text-[20px] ss:text-[14px] font-medium">
                        Issue 6
...
export default SectionWrapper(EJHIVVol2Issues, '');