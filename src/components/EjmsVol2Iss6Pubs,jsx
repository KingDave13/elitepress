...
import { Ejmsvol2iss6 } from "../constants";
...
const EjmsVol2Iss6Pubs = () => {
    ...
    const totalItems = Ejmsvol2iss6.length;
    ...
    const currentItems = Ejmsvol2iss6.slice(startIndex, endIndex);
...
export default SectionWrapper(EjmsVol2Iss6Pubs, '');