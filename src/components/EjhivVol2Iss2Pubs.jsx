...
import { Ejhivvol2iss2 } from "../constants";
...
const EjhivVol2Iss2Pubs = () => {
    ...
    const totalItems = Ejhivvol2iss2.length;
    ...
    const currentItems = Ejhivvol2iss2.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhivVol2Iss2Pubs, '');