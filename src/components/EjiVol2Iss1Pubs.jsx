...
import { Ejivol2iss1 } from "../constants";
...
const EjiVol2Iss1Pubs = () => {
    ...
    const totalItems = Ejivol2iss1.length;
    ...
    const currentItems = Ejivol2iss1.slice(startIndex, endIndex);
...
export default SectionWrapper(EjiVol2Iss1Pubs, '');