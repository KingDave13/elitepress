...
import { Ejhivvol2iss6 } from "../constants";
...
const EjhivVol2Iss6Pubs = () => {
    ...
    const totalItems = Ejhivvol2iss6.length;
    ...
    const currentItems = Ejhivvol2iss6.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhivVol2Iss6Pubs, '');