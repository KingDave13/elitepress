...
import { Ejmsvol1iss1 } from "../constants";
...
const EjmsVol1Iss1Pubs = () => {
    ...
    const totalItems = Ejmsvol1iss1.length;
    ...
    const currentItems = Ejmsvol1iss1.slice(startIndex, endIndex);
...
export default SectionWrapper(EjmsVol1Iss1Pubs, '');