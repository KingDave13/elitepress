...
import { Ejhivvol2iss7 } from "../constants";
...
const EjhivVol2Iss7Pubs = () => {
    ...
    const totalItems = Ejhivvol2iss7.length;
    ...
    const currentItems = Ejhivvol2iss7.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhivVol2Iss7Pubs, '');