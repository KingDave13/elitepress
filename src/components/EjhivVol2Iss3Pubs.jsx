...
import { Ejhivvol2iss3 } from "../constants";
...
const EjhivVol2Iss3Pubs = () => {
    ...
    const totalItems = Ejhivvol2iss3.length;
    ...
    const currentItems = Ejhivvol2iss3.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhivVol2Iss3Pubs, '');