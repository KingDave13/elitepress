...
import { Ejnhsvol2iss5 } from "../constants";
...
const EjnhsVol2Iss5Pubs = () => {
    ...
    const totalItems = Ejnhsvol2iss5.length;
    ...
    const currentItems = Ejnhsvol2iss5.slice(startIndex, endIndex);
...
export default SectionWrapper(EjnhsVol2Iss5Pubs, '');