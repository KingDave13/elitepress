...
import { Ejsrrvol2iss1 } from "../constants";
...
const EjsrrVol2Iss1Pubs = () => {
    ...
    const totalItems = Ejsrrvol2iss1.length;
    ...
    const currentItems = Ejsrrvol2iss1.slice(startIndex, endIndex);
...
export default SectionWrapper(EjsrrVol2Iss1Pubs, '');