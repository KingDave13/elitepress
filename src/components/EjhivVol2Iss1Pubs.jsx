...
import { Ejhivvol2iss1 } from "../constants";
...
const EjhivVol2Iss1Pubs = () => {
    ...
    const totalItems = Ejhivvol2iss1.length;
    ...
    const currentItems = Ejhivvol2iss1.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhivVol2Iss1Pubs, '');