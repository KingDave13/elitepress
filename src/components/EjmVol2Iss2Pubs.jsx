...
import { Ejmvol2iss2 } from "../constants";
...
const EjmVol2Iss2Pubs = () => {
    ...
    const totalItems = Ejmvol2iss2.length;
    ...
    const currentItems = Ejmvol2iss2.slice(startIndex, endIndex);
...
export default SectionWrapper(EjmVol2Iss2Pubs, '');