...
import { Ejlmvol2iss6 } from "../constants";
...
const EjlmVol2Iss6Pubs = () => {
    ...
    const totalItems = Ejlmvol2iss6.length;
    ...
    const currentItems = Ejlmvol2iss6.slice(startIndex, endIndex);
...
export default SectionWrapper(EjlmVol2Iss6Pubs, '');