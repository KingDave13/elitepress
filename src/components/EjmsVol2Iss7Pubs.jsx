...
import { Ejmsvol2iss7 } from "../constants";
...
const EjmsVol2Iss7Pubs = () => {
    ...
    const totalItems = Ejmsvol2iss7.length;
    ...
    const currentItems = Ejmsvol2iss7.slice(startIndex, endIndex);
...
export default SectionWrapper(EjmsVol2Iss7Pubs, '');