...
import { Ejhvol2iss7 } from "../constants";
...
const EjhVol2Iss7Pubs = () => {
    ...
    const totalItems = Ejhvol2iss7.length;
    ...
    const currentItems = Ejhvol2iss7.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhVol2Iss7Pubs, '');