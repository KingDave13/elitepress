...
import { Ejnhsvol2iss1 } from "../constants";
...
const EjnhsVol2Iss1Pubs = () => {
    ...
    const totalItems = Ejnhsvol2iss1.length;
    ...
    const currentItems = Ejnhsvol2iss1.slice(startIndex, endIndex);
...
export default SectionWrapper(EjnhsVol2Iss1Pubs, '');