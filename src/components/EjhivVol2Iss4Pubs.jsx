...
import { Ejhivvol2iss4 } from "../constants";
...
const EjhivVol2Iss4Pubs = () => {
    ...
    const totalItems = Ejhivvol2iss4.length;
    ...
    const currentItems = Ejhivvol2iss4.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhivVol2Iss4Pubs, '');