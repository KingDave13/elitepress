...
import { Ejivol2iss4 } from "../constants";
...
const EjiVol2Iss4Pubs = () => {
    ...
    const totalItems = Ejivol2iss4.length;
    ...
    const currentItems = Ejivol2iss4.slice(startIndex, endIndex);
...
export default SectionWrapper(EjiVol2Iss4Pubs, '');