...
import { Ejivol2iss3 } from "../constants";
...
const EjiVol2Iss3Pubs = () => {
    ...
    const totalItems = Ejivol2iss3.length;
    ...
    const currentItems = Ejivol2iss3.slice(startIndex, endIndex);
...
export default SectionWrapper(EjiVol2Iss3Pubs, '');