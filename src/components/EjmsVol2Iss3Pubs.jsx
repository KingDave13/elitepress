...
import { Ejmsvol2iss3 } from "../constants";
...
const EjmsVol2Iss3Pubs = () => {
    ...
    const totalItems = Ejmsvol2iss3.length;
    ...
    const currentItems = Ejmsvol2iss3.slice(startIndex, endIndex);
...
export default SectionWrapper(EjmsVol2Iss3Pubs, '');