...
import { Ejsrrvol2iss5 } from "../constants";
...
const EjsrrVol2Iss5Pubs = () => {
    ...
    const totalItems = Ejsrrvol2iss5.length;
    ...
    const currentItems = Ejsrrvol2iss5.slice(startIndex, endIndex);
...
export default SectionWrapper(EjsrrVol2Iss5Pubs, '');