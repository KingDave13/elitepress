...
import { Ejmvol2iss4 } from "../constants";
...
const EjmVol2Iss4Pubs = () => {
    ...
    const totalItems = Ejmvol2iss4.length;
    ...
    const currentItems = Ejmvol2iss4.slice(startIndex, endIndex);
...
export default SectionWrapper(EjmVol2Iss4Pubs, '');