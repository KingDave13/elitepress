...
import { Ejlmvol2iss4 } from "../constants";
...
const EjlmVol2Iss4Pubs = () => {
    ...
    const totalItems = Ejlmvol2iss4.length;
    ...
    const currentItems = Ejlmvol2iss4.slice(startIndex, endIndex);
...
export default SectionWrapper(EjlmVol2Iss4Pubs, '');