...
import { Ejhsvol2iss6 } from "../constants";
...
const EjhsVol2Iss6Pubs = () => {
    ...
    const totalItems = Ejhsvol2iss6.length;
    ...
    const currentItems = Ejhsvol2iss6.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhsVol2Iss6Pubs, '');