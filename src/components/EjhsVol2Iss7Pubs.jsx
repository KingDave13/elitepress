...
import { Ejhsvol2iss7 } from "../constants";
...
const EjhsVol2Iss7Pubs = () => {
    ...
    const totalItems = Ejhsvol2iss7.length;
    ...
    const currentItems = Ejhsvol2iss7.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhsVol2Iss7Pubs, '');