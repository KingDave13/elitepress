...
import { Ejmsvol2iss8 } from "../constants";
...
const EjmsVol2Iss8Pubs = () => {
    ...
    const totalItems = Ejmsvol2iss8.length;
    ...
    const currentItems = Ejmsvol2iss8.slice(startIndex, endIndex);
...
export default SectionWrapper(EjmsVol2Iss8Pubs, '');