...
import { Ejlmvol2iss5 } from "../constants";
...
const EjlmVol2Iss5Pubs = () => {
    ...
    const totalItems = Ejlmvol2iss5.length;
    ...
    const currentItems = Ejlmvol2iss5.slice(startIndex, endIndex);
...
export default SectionWrapper(EjlmVol2Iss5Pubs, '');