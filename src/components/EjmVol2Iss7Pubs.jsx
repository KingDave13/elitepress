...
import { Ejmvol2iss7 } from "../constants";
...
const EjmVol2Iss7Pubs = () => {
    ...
    const totalItems = Ejmvol2iss7.length;
    ...
    const currentItems = Ejmvol2iss7.slice(startIndex, endIndex);
...
export default SectionWrapper(EjmVol2Iss7Pubs, '');