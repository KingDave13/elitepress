...
import { vol1iss1 } from "../constants";
...
const Vol1Iss1Pubs = () => {
    ...
    const totalItems = vol1iss1.length;
    ...
    const currentItems = vol1iss1.slice(startIndex, endIndex);
...
export default SectionWrapper(Vol1Iss1Pubs, '');