...
import { Ejhsvol2iss3 } from "../constants";
...
const EjhsVol2Iss3Pubs = () => {
    ...
    const totalItems = Ejhsvol2iss3.length;
    ...
    const currentItems = Ejhsvol2iss3.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhsVol2Iss3Pubs, '');