...
import { vol2iss3 } from "../constants";
...
const Vol2Iss3Pubs = () => {
    ...
    const totalItems = vol2iss3.length;
    ...
    const currentItems = vol2iss3.slice(startIndex, endIndex);
...
export default SectionWrapper(Vol2Iss3Pubs, '');