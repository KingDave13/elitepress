...
import { Ejlmvol1iss1 } from "../constants";
...
const EjlmVol1Iss1Pubs = () => {
    ...
    const totalItems = Ejlmvol1iss1.length;
    ...
    const currentItems = Ejlmvol1iss1.slice(startIndex, endIndex);
...
export default SectionWrapper(EjlmVol1Iss1Pubs, '');