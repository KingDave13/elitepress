...
import { Ejhsvol2iss5 } from "../constants";
...
const EjhsVol2Iss5Pubs = () => {
    ...
    const totalItems = Ejhsvol2iss5.length;
    ...
    const currentItems = Ejhsvol2iss5.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhsVol2Iss5Pubs, '');