...
import { Ejhivvol1iss1 } from "../constants";
...
const EjhivVol1Iss1Pubs = () => {
    ...
    const totalItems = Ejhivvol1iss1.length;
    ...
    const currentItems = Ejhivvol1iss1.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhivVol1Iss1Pubs, '');