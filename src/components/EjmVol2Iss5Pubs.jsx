...
import { Ejmvol2iss5 } from "../constants";
...
const EjmVol2Iss5Pubs = () => {
    ...
    const totalItems = Ejmvol2iss5.length;
    ...
    const currentItems = Ejmvol2iss5.slice(startIndex, endIndex);
...
export default SectionWrapper(EjmVol2Iss5Pubs, '');