...
import { Ejhvol2iss3 } from "../constants";
...
const EjhVol2Iss3Pubs = () => {
    ...
    const totalItems = Ejhvol2iss3.length;
    ...
    const currentItems = Ejhvol2iss3.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhVol2Iss3Pubs, '');