      ...
      <section className='w-full'>
          ...
          >
              ...
              >
                ...
                <div className='flex flex-row md:items-center ss:items-center 
                md:gap-3 ss:gap-2 gap-1 text-white md:text-[20px] 
                ss:text-[20px] text-[13px] justify-center'>
                  <p>Home</p>
                  ...
                  <BsArrowRightShort className='md:text-[30px] 
                  ss:text-[30px] text-[22px] text-white'/>
                  <p>Elite Journal of Laboratory Medicine</p>
                </div>
              </motion.div>          
          </div>
      </section>  
...
export default SectionWrapper(HeroEJLM, '');