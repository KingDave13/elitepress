...
import { Ejnhsvol2iss7 } from "../constants";
...
const EjnhsVol2Iss7Pubs = () => {
    ...
    const totalItems = Ejnhsvol2iss7.length;
    ...
    const currentItems = Ejnhsvol2iss7.slice(startIndex, endIndex);
...
export default SectionWrapper(EjnhsVol2Iss7Pubs, '');