...
import { vol2iss5 } from "../constants";
...
const Vol2Iss5Pubs = () => {
    ...
    const totalItems = vol2iss5.length;
    ...
    const currentItems = vol2iss5.slice(startIndex, endIndex);
...
export default SectionWrapper(Vol2Iss5Pubs, '');