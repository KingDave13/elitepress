...
import { Ejhvol2iss6 } from "../constants";
...
const EjhVol2Iss6Pubs = () => {
    ...
    const totalItems = Ejhvol2iss6.length;
    ...
    const currentItems = Ejhvol2iss6.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhVol2Iss6Pubs, '');