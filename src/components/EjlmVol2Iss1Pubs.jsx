...
import { Ejlmvol2iss1 } from "../constants";
...
const EjlmVol2Iss1Pubs = () => {
    ...
    const totalItems = Ejlmvol2iss1.length;
    ...
    const currentItems = Ejlmvol2iss1.slice(startIndex, endIndex);
...
export default SectionWrapper(EjlmVol2Iss1Pubs, '');