...
import { Ejnhsvol1iss1 } from "../constants";
...
const EjnhsVol1Iss1Pubs = () => {
    ...
    const totalItems = Ejnhsvol1iss1.length;
    ...
    const currentItems = Ejnhsvol1iss1.slice(startIndex, endIndex);
...
export default SectionWrapper(EjnhsVol1Iss1Pubs, '');