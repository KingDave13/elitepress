...
import { Ejnhsvol2iss6 } from "../constants";
...
const EjnhsVol2Iss6Pubs = () => {
    ...
    const totalItems = Ejnhsvol2iss6.length;
    ...
    const currentItems = Ejnhsvol2iss6.slice(startIndex, endIndex);
...
export default SectionWrapper(EjnhsVol2Iss6Pubs, '');