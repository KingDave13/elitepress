...
import { Ejnhsvol2iss2 } from "../constants";
...
const EjnhsVol2Iss2Pubs = () => {
    ...
    const totalItems = Ejnhsvol2iss2.length;
    ...
    const currentItems = Ejnhsvol2iss2.slice(startIndex, endIndex);
...
export default SectionWrapper(EjnhsVol2Iss2Pubs, '');