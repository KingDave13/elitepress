...
import { Ejivol2iss5 } from "../constants";
...
const EjiVol2Iss5Pubs = () => {
    ...
    const totalItems = Ejivol2iss5.length;
    ...
    const currentItems = Ejivol2iss5.slice(startIndex, endIndex);
...
export default SectionWrapper(EjiVol2Iss5Pubs, '');