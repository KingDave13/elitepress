...
import { vol2iss6 } from "../constants";
...
const Vol2Iss6Pubs = () => {
    ...
    const totalItems = vol2iss6.length;
    ...
    const currentItems = vol2iss6.slice(startIndex, endIndex);
...
export default SectionWrapper(Vol2Iss6Pubs, '');