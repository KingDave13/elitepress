...
import { Ejhsvol2iss2 } from "../constants";
...
const EjhsVol2Iss2Pubs = () => {
    ...
    const totalItems = Ejhsvol2iss2.length;
    ...
    const currentItems = Ejhsvol2iss2.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhsVol2Iss2Pubs, '');