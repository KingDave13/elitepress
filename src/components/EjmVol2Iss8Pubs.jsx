...
import { Ejmvol2iss8 } from "../constants";
...
const EjmVol2Iss8Pubs = () => {
    ...
    const totalItems = Ejmvol2iss8.length;
    ...
    const currentItems = Ejmvol2iss8.slice(startIndex, endIndex);
...
export default SectionWrapper(EjmVol2Iss8Pubs, '');