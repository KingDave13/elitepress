...
import { Ejmsvol2iss1 } from "../constants";
...
const EjmsVol2Iss1Pubs = () => {
    ...
    const totalItems = Ejmsvol2iss1.length;
    ...
    const currentItems = Ejmsvol2iss1.slice(startIndex, endIndex);
...
export default SectionWrapper(EjmsVol2Iss1Pubs, '');