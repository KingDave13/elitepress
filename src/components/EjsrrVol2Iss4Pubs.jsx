...
import { Ejsrrvol2iss4 } from "../constants";
...
const EjsrrVol2Iss4Pubs = () => {
    ...
    const totalItems = Ejsrrvol2iss4.length;
    ...
    const currentItems = Ejsrrvol2iss4.slice(startIndex, endIndex);
...
export default SectionWrapper(EjsrrVol2Iss4Pubs, '');