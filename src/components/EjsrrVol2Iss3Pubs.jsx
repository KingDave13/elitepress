...
import { Ejsrrvol2iss3 } from "../constants";
...
const EjsrrVol2Iss3Pubs = () => {
    ...
    const totalItems = Ejsrrvol2iss3.length;
    ...
    const currentItems = Ejsrrvol2iss3.slice(startIndex, endIndex);
...
export default SectionWrapper(EjsrrVol2Iss3Pubs, '');