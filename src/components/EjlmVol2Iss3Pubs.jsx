...
import { Ejlmvol2iss3 } from "../constants";
...
const EjlmVol2Iss3Pubs = () => {
    ...
    const totalItems = Ejlmvol2iss3.length;
    ...
    const currentItems = Ejlmvol2iss3.slice(startIndex, endIndex);
...
export default SectionWrapper(EjlmVol2Iss3Pubs, '');