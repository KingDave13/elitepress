...
import { Ejhsvol1iss1 } from "../constants";
...
const EjhsVol1Iss1Pubs = () => {
    ...
    const totalItems = Ejhsvol1iss1.length;
    ...
    const currentItems = Ejhsvol1iss1.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhsVol1Iss1Pubs, '');