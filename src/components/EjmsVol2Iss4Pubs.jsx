...
import { Ejmsvol2iss4 } from "../constants";
...
const EjmsVol2Iss4Pubs = () => {
    ...
    const totalItems = Ejmsvol2iss4.length;
    ...
    const currentItems = Ejmsvol2iss4.slice(startIndex, endIndex);
...
export default SectionWrapper(EjmsVol2Iss4Pubs, '');