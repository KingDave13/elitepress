...
import { vol2iss4 } from "../constants";
...
const Vol2Iss4Pubs = () => {
    ...
    const totalItems = vol2iss4.length;
    ...
    const currentItems = vol2iss4.slice(startIndex, endIndex);
...
export default SectionWrapper(Vol2Iss4Pubs, '');