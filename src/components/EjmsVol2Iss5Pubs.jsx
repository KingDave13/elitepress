...
import { Ejmsvol2iss5 } from "../constants";
...
const EjmsVol2Iss5Pubs = () => {
    ...
    const totalItems = Ejmsvol2iss5.length;
    ...
    const currentItems = Ejmsvol2iss5.slice(startIndex, endIndex);
...
export default SectionWrapper(EjmsVol2Iss5Pubs, '');