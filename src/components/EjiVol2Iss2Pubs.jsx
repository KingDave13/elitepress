...
import { Ejivol2iss2 } from "../constants";
...
const EjiVol2Iss2Pubs = () => {
    ...
    const totalItems = Ejivol2iss2.length;
    ...
    const currentItems = Ejivol2iss2.slice(startIndex, endIndex);
...
export default SectionWrapper(EjiVol2Iss2Pubs, '');