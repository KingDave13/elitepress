...
import { Ejnhsvol2iss3 } from "../constants";
...
const EjnhsVol2Iss3Pubs = () => {
    ...
    const totalItems = Ejnhsvol2iss3.length;
    ...
    const currentItems = Ejnhsvol2iss3.slice(startIndex, endIndex);
...
export default SectionWrapper(EjnhsVol2Iss3Pubs, '');