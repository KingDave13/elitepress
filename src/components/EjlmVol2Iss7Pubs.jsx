...
import { Ejlmvol2iss7 } from "../constants";
...
const EjlmVol2Iss7Pubs = () => {
    ...
    const totalItems = Ejlmvol2iss7.length;
    ...
    const currentItems = Ejlmvol2iss7.slice(startIndex, endIndex);
...
export default SectionWrapper(EjlmVol2Iss7Pubs, '');