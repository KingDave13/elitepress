...
import { Ejlmvol2iss2 } from "../constants";
...
const EjlmVol2Iss2Pubs = () => {
    ...
    const totalItems = Ejlmvol2iss2.length;
    ...
    const currentItems = Ejlmvol2iss2.slice(startIndex, endIndex);
...
export default SectionWrapper(EjlmVol2Iss2Pubs, '');