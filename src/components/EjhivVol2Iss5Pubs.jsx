...
import { Ejhivvol2iss5 } from "../constants";
...
const EjhivVol2Iss5Pubs = () => {
    ...
    const totalItems = Ejhivvol2iss5.length;
    ...
    const currentItems = Ejhivvol2iss5.slice(startIndex, endIndex);
...
export default SectionWrapper(EjhivVol2Iss5Pubs, '');